import {Box, Flex, Input, SimpleGrid, Card, Heading, Skeleton, Stack, Text, useToast} from "@chakra-ui/react"
import { Web3Button, useContractRead, useAddress, useContract, useTokenBalance} from "@thirdweb-dev/react"
            ...
            <SimpleGrid columns={2}>
                <Card p={5} m={5}>
                    <Box textAlign={"center"} mb={5}>
                        <Text fontSize={"xl"} fontWeight={"bold"}>Stale Token: </Text>
